...
namespace Assets.Scripts.Character
{
    ...
    [RequireComponent(typeof(CharacterStats.MonoBehavior.CharacterStats))]
    public class BaseController : MonoBehaviour
    {
        ...
        /// 角色数据
        /// </summary>
        protected CharacterStats.MonoBehavior.CharacterStats characterStats;
        ...
        void Awake()
        {
            ...
            characterStats = GetComponent<CharacterStats.MonoBehavior.CharacterStats>();
